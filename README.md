...
**Software Engineer · DevSecOps · Real-Time Systems**

I build and deploy software in environments where uptime and security aren't optional — DoD facilities, NAVAIR operations floors, and classified networks. My work sits at the intersection of full-stack development, infrastructure automation, and operational technology.

Previously at RTV Engineering, I deployed real-time asset tracking systems (RFID/RTLS) inside naval aviation facilities using containerized microservices, event-driven pipelines, and Azure DevOps CI/CD. Now I'm building in the open to show what I can do.
...
![RFID/RTLS](https://img.shields.io/badge/RFID%2FRTLS-FF6F00?style=flat)
![Claude API](https://img.shields.io/badge/Claude_API-D4A574?style=flat&logo=anthropic&logoColor=black)
